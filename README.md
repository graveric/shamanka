...
Альтернативная русская раскладка для раздельных клавиатур с вынесенной в тамб-кластер альфой, высокими чередованиями, низкими sfb и пониженной нагрузкой на мизинцы. Также минимизировано, по возможности, количество горизонтальных движений на указательных пальцах.
...
Для ещё большего понижения нагрузки на мизинцы можно использовать раскладку в режиме блока 3x5, убрав «лишние» альфы с мизинцев на комбо или в слой. Я использую комбо и моя повседневная раскладка выглядит так:
...
«Шаманка» проектировалась с расчётом на высокие чередования и комфорт пальцев. Возможно, она не обладает выдающимися катабельными характеристиками. Если для вас в первую очередь важны перекаты и one-hands, вероятно, она может вас не устроить в должной степени и есть смысл посмотреть на другие варианты.

Использую раскладку на постоянной основе около года (на июль 2026). Средняя скорость печати 60−65 WPM (пиковые значения 90−92, что не показательно, но тем не менее я там был и с проблемами, вызванными раскладкой, пока не повстречался). 
