...
Использую раскладку на постоянной основе около года (на июль 2026). Средняя скорость печати 60+ WPM (пиковые значения 90+, что не показательно, но тем не менее я там был и с проблемами, вызванными раскладкой, там не повстречался). 
